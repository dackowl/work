...
<html lang="en">
    ...
    <div id="nav">
      <div class="container">
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-1 col-md-1 col-lg-1 text-center">
          <a class="btn btn-warning" href="<?php echo U('login/register/index');?>">注册</a>
          </div>
          <div class="col-xs-12 col-sm-1 col-md-1 col-lg-1 text-center">
          <a class="btn btn-default" href="<?php echo U('login/login/index');?>">登录</a>
          </div>
          <div class="col-xs-12 col-sm-1 col-md-1 col-lg-1 text-center">
          ...
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
            <form class="form-horizontal" accept-charset="utf-8" ng-app='loginApp' ng-controller="loginCtrl" name="myForm" ng-cloak novalidate>
              ...
              <div class="row text-center">
                ...
                <a class="btn btn-primary" href="<?php echo U('login/login/index');?>">返回登录</a>
              </div>
            </form>
          </div>
        </div>
  ...
  <script type="text/javascript">
    ...
    app.controller('loginCtrl', function($scope, $http) {
      ...
      $http({
        url:"<?php echo U('Login/Login/rename');?>",
        method:'post',   
      ...
      $http({
        url:"<?php echo U('Login/Login/reg');?>",
        method:'post',   
          data:{
            myname:$scope.myname,
            mypwd:$scope.mypwd
         ...
         if (res.data.statu==0) {
          ...
          alert(res.data.msg);
          location.href="<?php echo U('Login/Login/index');?>";
         }
        }).catch(function (err) {
          console.log(err);
        }); 
