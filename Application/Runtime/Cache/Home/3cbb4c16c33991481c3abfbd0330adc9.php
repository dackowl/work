  ...
  <div class="sf">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?php echo U('User/home');?>">
          <p>蜂窝网</p>
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><a class="text-center" href="<?php echo U('Pro/index');?>">活动</a></li>
          <li><a class="text-center" href="<?php echo U('User/userCanter');?>">个人中心</a></li>
          <li></li>
          <li>
